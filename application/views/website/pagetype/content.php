	...
	$(document).ready(function(){
		...
		{ 
           var ID=$(".message_box:last").attr("id");
			...
			$.post("<?php echo base_url().$this->lang->lang(); ?>/pagetype/contentajax/<?php echo $current_alias; ?>?action=get&last_msg_id="+ID,
...
$page_rows=$this->Page_model->get_by_pagetype($pagetype_id, 20);
if(isset($page_rows)) {
...
$pagetype_id=$row->id;
$page_rows=$this->Page_model->get_by_pagetype_id_less_than($pagetype_id, $last_msg_id, 10);
