		 ...
		 $last_news_menus_links_count=count($last_news_menus_links);
		  ...
		  foreach($last_news_menus_links as $last_news_menus_link) {
		   ...
		   if($link_controller_name=='page') {
		   	$last_news_row=$this->Page_model->get_by_alias($link_alias);
                ...
                <!--end news letter-->
			     ...
			     <div class="videoContainer">
                    <div class="videoContainer-header">
                        ...
                        <a href="<?php echo base_url().$this->lang->lang().'/video'; ?>">المزيد</a>
                    </div>
                    <div>
                        <div>
...
<?php 
   ...
   ?>
                                ...
                                <li id="videoTab-2" style="height: 300px;">
                                    <ul class="videos ">
<?php 
$gallery_rows=$this->Gallery_model->get_all_limit(3);
...
?>
                                        ...
                                        <li id="homeGallery<?php echo $gallery_id;?>">
                                            <div class="selectedPhotos video-preview">
                                                <!--<div class="pager">
                                                    <div id="nxt"></div>
                                                ...
                                                <ul id="slideshow" class="slideshow1">
...
?>                                                   
                                                    <li>
                                                        <img src="<?php echo $image_full_path;?>" width="647" height="960" />
                                                    </li>
<?php 
  }
}
...
?>                                        
                                    ...
                                    <ul class="links homeGalleryTabs">
 <?php 
$counter_loop=0;
foreach ($gallery_rows as $gallery_row) {
...
<li><a href="#homeGallery<?php echo $gallery_id;?>"><?php echo $gallery_title; ?></a></li>
