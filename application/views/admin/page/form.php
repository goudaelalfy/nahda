...
if(!isset($page_category_ids)) {
$page_category_ids=		'';
}
if(!isset($page_category_names)) {
$page_category_names=	'';
}
if(!isset($page_type_ids)) {
$page_type_ids=		'';
}
...
if(!isset($page_page_ids)) {
$page_page_ids=		'';
}
if(!isset($page_page_names)) {
$page_page_names=	'';
}
...
if($mode!='add')
{
	...
	if($mode=='return')
	{
		...
		$writer_id=	$current_row['writer_id'];
		...
		$page_category_ids=	$current_row['page_category_ids'];
		$page_category_names=$current_row['page_category_names'];
		$page_type_ids=		$current_row['page_type_ids'];
		$page_type_names=	$current_row['page_type_names'];
		
		$page_page_ids=		$current_row['page_page_ids'];
		$page_page_names=	$current_row['page_page_names'];
 ...
 * Writer object.
 * 
 * Intialize object from Writer controller class.
 * @var object.
 */
$this->load->controller(ADMIN.'/Writer');
$writer_object= new Writer();
...
<div class="control-group">
<label class="control-label" for="focusedInput"><?php echo lang('page_types'); ?></label>
<div class="controls">
<div style="width:690px">
<input type="hidden" name="page_type_ids" id="page_type_ids" value="<?php echo $page_type_ids; ?>"> 
<input class="input-xlarge focused" type="text" readonly="readonly" name="page_type_names" id="page_type_names" value="<?php echo $page_type_names; ?>" style="width:600px;">
<a class='btn btn-primary' href='javascript:void(0)' onclick="PopupCenter('<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/page/popuppagetype/<?php echo $id;?>' , '<?php echo $this->lang->line('select_page_types')?>',400,500);" >::::</a>
<div class="dv_error"  id="dv_page_type_ids_false" style="display:none;"><?php echo lang('page_type_ids_false'); ?></div>
</div>
</div>
</div>	

<div class="control-group">
<label class="control-label" for="focusedInput"><?php echo lang('page_categories'); ?></label>
<div class="controls">
<div style="width:690px">
<input type="hidden" name="page_category_ids" id="page_category_ids" value="<?php echo $page_category_ids; ?>"> 
<input class="input-xlarge focused" type="text" readonly="readonly" name="page_category_names" id="page_category_names" value="<?php echo $page_category_names; ?>" style="width:600px;">
<a class='btn btn-primary' href='javascript:void(0)' onclick="PopupCenter('<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/page/popuppagecategory/<?php echo $id;?>' , '<?php echo $this->lang->line('select_page_categories')?>',400,500);" >::::</a>
<div class="dv_error"  id="dv_page_category_ids_false" style="display:none;"><?php echo lang('page_category_ids_false'); ?></div>
</div>
</div>
</div>	

<div class="control-group">
<label class="control-label" for="focusedInput"><?php echo lang('page_pages'); ?></label>
<div class="controls">
<div style="width:690px">
<input type="hidden" name="page_page_ids" id="page_page_ids" value="<?php echo $page_page_ids; ?>"> 
<input class="input-xlarge focused" type="text" readonly="readonly" name="page_page_names" id="page_page_names" value="<?php echo $page_page_names; ?>" style="width:600px;">
<a class='btn btn-primary' href='javascript:void(0)' onclick="PopupCenter('<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/page/popupself/<?php echo $id;?>' , '<?php echo $this->lang->line('select_page_pages')?>',400,500);" >::::</a>
<div class="dv_error"  id="dv_page_page_ids_false" style="display:none;"><?php echo lang('page_page_ids_false'); ?></div>
</div>
</div>
</div>	
...
<div class="control-group">
<label class="control-label" for="focusedInput"><?php echo lang('writer'); ?></label>
<div class="controls">
<?php $dropdowns->drpdwn_writer($writer_object, $writer_id,'writer_id',$are_disabled); ?>
  <div class="dv_error" id="dv_writer_false" style="display:none; "><?php echo lang('writer_false'); ?></div>
