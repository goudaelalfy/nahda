	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="http://www.nahdaislah.com" target="_blank"> <span><?php echo lang('admin_panel_title');?></span></a>
				...
				<div class="top-nav nav-collapse">
					<ul class="nav">
						<li><a href="http://www.nahdaislah.com" target="_blank"><?php echo lang('lnk_visit_site');?></a></li>
						<li>
						<!-- 
