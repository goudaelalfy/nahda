...
<h2><i class="icon-edit"></i> <?php echo lang('pages_writers')?></h2>
<div class="box-icon">
...
<form class="form-horizontal" id='frm_import_pagescats_row' name='frm_import_pagescats_row'  method='post' enctype='multipart/form-data'>
...
<label class="control-label" for="focusedInput"><?php echo lang('page_id'); ?></label>
<div class="controls">
	<?php echo dropdown($sheetData,'page_id'); ?>
</div>
</div>	
 
<div class="control-group">
<label class="control-label" for="focusedInput"><?php echo lang('writer_id'); ?></label>
<div class="controls">
	<?php echo dropdown($sheetData,'writer_id'); ?>
</div>
</div>	
