...
<form class="form-horizontal" id='frm_import_writer_row' name='frm_import_writer_row'  method='post' enctype='multipart/form-data'>
...
<label class="control-label" for="focusedInput"><?php echo lang('ID'); ?></label>
<div class="controls">
	<?php echo dropdown($sheetData,'id'); ?>
</div>
</div>	
...
<div class="controls">
	<?php echo dropdown($sheetData,'name'); ?>
</div>
</div>
...
<div class="controls">
	<?php echo dropdown($sheetData,'name_ar'); ?>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="focusedInput"><?php echo lang('approved'); ?></label>
<div class="controls">
	<?php echo dropdown($sheetData,'approved'); ?>
</div>
</div>

<div class="control-group">
<label class="control-label" for="focusedInput"><?php echo lang('deleted'); ?></label>
<div class="controls">
	<?php echo dropdown($sheetData,'deleted'); ?>
</div>
</div>

<div class="control-group">
<label class="control-label" for="focusedInput"><?php echo lang('last_modify_date'); ?></label>
<div class="controls">
	<?php echo dropdown($sheetData,'last_modify_date'); ?>
</div>
</div>
