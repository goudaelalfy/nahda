...
<h2><i class="icon-edit"></i> <?php echo lang('news')?></h2>
<div class="box-icon">
...
<form class="form-horizontal" id='frm_import_news_row' name='frm_import_news_row'  method='post' enctype='multipart/form-data'>
