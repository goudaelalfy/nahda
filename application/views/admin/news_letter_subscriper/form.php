...
<script type='text/javascript'  src='<?php echo base_url();?>js/admin/news_letter_subscriper/form.js' > </script>
...
/**
 * Newslettersubscriper controller object.
 * 
 * Intialize object from Newslettersubscriper controller class.
 * @var object.
 */

$this_object= new Newslettersubscriper();
...
$("#dv_username_true").html('');
    $.ajax({  
    type: "POST",  
    url: "<?php echo base_url().$this->lang->lang().'/'.ADMIN; ?>/newslettersubscriper/check_username_availability/<?php echo $id; ?>",  
    data: "username="+ usr,  
...
<h2><i class="icon-edit"></i> <?php echo lang('news_letter_subscripers')?></h2>
<div class="box-icon">
...
<form class="form-horizontal" id='frm_newslettersubscriper_row' name='frm_newslettersubscriper_row'  method='post' enctype='multipart/form-data'>
...
<input type="hidden" name="last_modify_date" id="last_modify_date" value="<?php echo $last_modify_date; ?>"> 
	...
	<a class='btn btn-success' href='<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/newslettersubscriper/table'>
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_add)) {
	...
	<a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/newslettersubscriper/form/0/add">
...
if($this_object->user_screen_privielge_allowed($this_object->screen_id, $this_object->privielge_edit)) {
    ...
    <a class='btn btn-info' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/newslettersubscriper/form/<?php echo $id;?>/edit">
    <i class='icon-edit icon-white'></i>  
...
?>		
	...
	<a class='btn btn-danger' href="<?php echo base_url().$this->lang->lang().'/'.ADMIN;?>/newslettersubscriper/delete/<?php echo $id;?>" onclick="return delete_confirm('<?php echo $this->lang->lang(); ?>')">
