...
class Menu_link_model extends My_Model
{
	...
	*/
	...
	{
	    $this->db->select('menu_link.`id`, menu_link.`controller_name`,  menu_link.`alias`,  menu_link.`parent_id`,  menu_link.`title`,  menu_link.`title_ar`,  menu_link.`sort`, menu_link.`icon`, menu_link.`style`,  menu_link.`menu_id`, menu.`title` as menu_title, menu.`title_ar` as menu_title_ar');
