...
/**
 * Importpagescats controller file.
 *
 * Contains controller class of import pagescats table.
 *
...
/**
 * Controller class  import pagescats table.
 *
 * This is the controller class to import pagescats table. between model and view, in MVC design pattern.
 *
 * @package		admin
 * @category	controller
 * @author		Eng Gouda Elalfy <goudaelalfy@hotmail.com>
 */
class Importpagescats extends MY_Controller
{
	/**
	 * store this controller importpagescats screen id.
	 *
	 * @var int
	 * @access public
	 */
	public $screen_id=43;
		...
		/**
	 * store this controller pagescats table name.
	 *
	 * @var string
	 * @access public
	 */
...
/*
	...
	*/			{
			...
			$this->load->view('admin/import_excel/pagescats',$data);
		}
			...
			if($this->session->userdata('excel_file_session'))
			{
				...
				foreach($sheetData as $row_arr)
				{
					if($row_counter>0)
					{
						...
						$data = array(
						'page_id' => $row_arr[$_POST['page_id']],
						'page_category_id' => $row_arr[$_POST['page_category_id']],
						);
						 
						$this->Pagecats_model->insert($this->table, $data);
					}
