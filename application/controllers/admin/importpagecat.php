...
/**
 * Importpagecat controller file.
 *
 * Contains controller class of import pagecat table.
 *
...
/**
 * Controller class  import pagecat table.
 *
 * This is the controller class to import pagecat table. between model and view, in MVC design pattern.
 *
 * @package		admin
 * @category	controller
 * @author		Eng Gouda Elalfy <goudaelalfy@hotmail.com>
 */
class Importpagecat extends MY_Controller
{
	/**
	 * store this controller importpagecat screen id.
	 *
	 * @var int
	 * @access public
	 */
	public $screen_id=42;
		...
		/**
	 * store this controller pagecat table name.
	 *
	 * @var string
	 * @access public
	 */
...
/*
	...
	*/			{
			...
			$this->load->view('admin/import_excel/pagecat',$data);
		}
			...
			if($this->session->userdata('excel_file_session'))
			{
				...
				foreach($sheetData as $row_arr)
				{
					if($row_counter>0)
					{
						...
						$this->pagecat_model->insert($this->table, $data);
					}
