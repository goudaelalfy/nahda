...
/**
 * Importnews controller file.
 *
 * Contains controller class of the importnews table.
 *
...
/**
 * Controller class of the importnews table.
 *
 * This is the controller class of the importnews table. between model and view, in MVC design pattern.
 *
 * @package		admin
 * @category	controller
 * @author		Eng Gouda Elalfy <goudaelalfy@hotmail.com>
 */
class Importnews extends MY_Controller
{
	/**
	 * store this controller importnews screen id.
	 *
	 * @var int
	 * @access public
	 */
...
/*
	...
	*/			{
			...
			$this->load->view('admin/import_excel/news',$data);
		}
			...
			if($this->session->userdata('excel_file_session'))
			{
				...
				foreach($sheetData as $row_arr)
				{
					if($row_counter>0)
					{
						...
						$this->News_model->insertIgnore($this->table, $data);
					}
