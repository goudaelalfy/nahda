			...
			if($this->session->userdata('excel_file_session'))
			{
				...
				foreach($sheetData as $row_arr)
				{
					if($row_counter>0)
					{
						...
						$this->Page_model->insertIgnore($this->table, $data);
						*/
						
						$image_id = $row_arr[$_POST['id']];
						$image_binary = $row_arr[$_POST['alias']];
					    $image_type = $row_arr[$_POST['title']];
						...
						$data = array(
						'banner_image_thumbs' =>  $picture_id,
						'banner_files' =>  $picture_id,
						'banner_image_thumb_selected' =>  $picture_id, 
						'banner_file_selected' =>  $picture_id
						
						);
						
						//$this->Page_model->updatePictureID('page', $picture_id ,$data);
						*/
						...
						$this->News_model->insertIgnore('news_image', $data);
					}
