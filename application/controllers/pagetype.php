 ...
 *
 * Contains controller class of the Pagetype entity.
 *
...
class Pagetype extends CI_Controller
{
	...
	public function content($alias='')
	{
		...
		$row=$this->Pagetype_model->get_by_alias($alias);
		$data['row']=$row;
		...
		$pagetype_id=$row->id;
		$page_rows=$this->Page_model->get_by_pagetype($pagetype_id);
		...
		*/
		...
		$this->load->view("website/pagetype/content", $data);
	}
